...
final class Version20181208231734 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE animal (id INT AUTO_INCREMENT NOT NULL, raça_id INT DEFAULT NULL, name_animal VARCHAR(50) NOT NULL, date_birth_animal DATE NOT NULL, INDEX IDX_6AAB231FE977AD0D (raça_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE animal_client ADD CONSTRAINT FK_7DB5C1898E962C16 FOREIGN KEY (animal_id) REFERENCES animal (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE breed ADD CONSTRAINT FK_F8AF884FB2A1D860 FOREIGN KEY (species_id) REFERENCES species (id)');
        $this->addSql('ALTER TABLE animal ADD CONSTRAINT FK_6AAB231FE977AD0D FOREIGN KEY (raça_id) REFERENCES species (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE animal DROP FOREIGN KEY FK_6AAB231FE977AD0D');
