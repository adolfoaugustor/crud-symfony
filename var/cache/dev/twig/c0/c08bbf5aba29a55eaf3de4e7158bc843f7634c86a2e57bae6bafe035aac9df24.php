...
class __TwigTemplate_33c6b7a2d78d502774c4f69fc37222a6515b444181a29d633b2a8586360337e6 extends Twig_Template
{
    private $source;
...
{% if admin.hasAccess('create') and admin.hasRoute('create') %}
    ...
    {% endif %}
{% endif %}
", "@SonataAdmin/Button/create_button.html.twig", "/var/www/html/crud-symfony/vendor/sonata-project/admin-bundle/src/Resources/views/Button/create_button.html.twig");
    }
}
